...
of change is desired, but they are relatively rare. Using the `destructive` ([GoDoc](https://pkg.go.dev/github.com/iasthc/atlas@master/sql/sqlcheck/destructive))
...
behavior. Using the `data_depend` ([GoDoc](https://pkg.go.dev/github.com/iasthc/atlas@master/sql/sqlcheck/datadepend))
