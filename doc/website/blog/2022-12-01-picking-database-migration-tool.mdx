...
- 1: Atlas provides [a few packages](https://pkg.go.dev/github.com/iasthc/atlas#section-directories) related to database operations, but the use is limited to complex cases
