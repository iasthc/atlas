module github.com/iasthc/atlas/internal/integration

go 1.20

replace github.com/iasthc/atlas => ../../

replace github.com/iasthc/atlas/cmd/atlas => ../../cmd/atlas

require (
	github.com/iasthc/atlas v0.10.2-0.20230508104407-ca9e095759fb
...
require (
	github.com/iasthc/atlas/cmd/atlas v0.10.2-0.20230508104407-ca9e095759fb // indirect
